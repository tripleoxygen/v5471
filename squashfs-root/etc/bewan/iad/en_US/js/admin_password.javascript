...
var Page = (function($, App) {
    ...
    function checkRules() {
        ...
        if (regExp1.test(val) && regExp2.test(val) && val.length >= 8 ) {
            ...
            Messages.error('Sorry, your password is not secured enough. Your password must be at least 8 characters and a mix of letters and numbers. Please key in another password.');
            return false
        }
    }
                ...
                xhr_object.onreadystatechange = function()
                {
                    if(xhr_object.readyState == 4)
                    {
                        ...
                        if (resp.indexOf("pwd=ko", 0) >= 0) {
                            ...
                            Messages.info('Successfully changed password');
