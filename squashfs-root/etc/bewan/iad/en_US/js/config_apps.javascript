    ...
    function initUI() {
        ...
        populateHosts();
         ...
         $("#addRule").bind("click", function() {
            ...
            if (app =='' ) {
                Messages.error('Please enter a game/application in the list before saving');
                return;
            }
            if (ip =='') {
                Messages.error('Please enter a computer in the list before saving');
                return;
            }
            ...
            if(app) {
                ...
                service.addPortMapping(mappings, function(res, addedMappings) {
                    ...
                    Messages.info('Port forwarding rule successfully added.');
